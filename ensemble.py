...
if __name__ == "__main__":
    ...
    if arg.joint_motion_dir is not None and arg.bone_motion_dir is not None:
        # arg.alpha = [2, 2, 1, 1]            # For ntu/xsub
        # arg.alpha = [0.6, 0.6, 0.4, 0.4]    # For ntu/xview & NW-UCLA
        # arg.alpha = [0.6, 0.75, 0.3, 0.15]  # For ntu120
        # arg.alpha = [0.6, 0.6, 0.15, 0.15]
        # arg.alpha = [0.55, 0.6, 0.45, 0.05]
